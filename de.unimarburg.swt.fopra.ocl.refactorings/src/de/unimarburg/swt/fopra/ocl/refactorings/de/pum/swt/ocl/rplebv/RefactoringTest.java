...
public class RefactoringTest extends JUnitTestCaseAdapter {
	...
	public RefactoringTest(String number) throws IOException {
		super("de.pum.swt.ocl.rplebv",
			"completeoclcs",
			new File(".").getCanonicalPath(),
			new Refactoring(null, "", "http://www.eclipse.org/ocl/3.1.0/CompleteOCLCST", new RefactoringGuiHandler(), new RefactoringController()));
	...
	private static List<String> getTestNumbers() {
		...
		try {
			String pathPrefix = new File(".").getCanonicalPath() + "/tests/" + "de.pum.swt.ocl.rplebv";
